...
class KnockoutInitializer {
    constructor(knockoutComponents) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const KnockoutComponent_1 = require("./KnockoutComponent");
const Button_1 = require("./content/button/Button");
const KnockoutInitializer_1 = require("./KnockoutInitializer");
const ko = require("knockout");
function registerComponent(data) {
    let component = new KnockoutComponent_1.KnockoutComponent(data.template, new Button_1.Button(data.name));
    let initializer = new KnockoutInitializer_1.KnockoutInitializer([component]);
